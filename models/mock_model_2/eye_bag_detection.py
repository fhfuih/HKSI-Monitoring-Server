...
class EyeBagDetection:
    ...
    def detect_dark_circles(self, image, landmarks, average_skin_color, threshold=40):
        ...
        return left_eye_color_distance > threshold, right_eye_color_distance > threshold
    ...
    def run(self, image):
        ...
        has_dark_circles_left, has_dark_circles_right = self.detect_dark_circles(image, landmarks, average_skin_color)
                
        return has_dark_circles_left, has_dark_circles_right
